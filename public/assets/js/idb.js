...
request.onupgradeneeded = function(event) {
  ...
  // creat an object store (table) called new_pizza, set it to have auto incrementing primary keys
...
request.onsuccess = function(event) {
  ...
  // check if app is online, is yes run uploadPizza()
  if (navigator.onLine) {
    uploadPizza();
  }
};
...
// this will be executed if we attempt to submit a new pizza with no internet connection
